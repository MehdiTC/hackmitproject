...
export const metadata: Metadata = {
  title: "Lock-In - Focus Platform",
  description: "Distraction-free study sessions with AI-powered focus tools",
  generator: "v0.app",
  manifest: "/manifest.json",
  themeColor: "#C15F3C", // Updated to Claude's primary color
